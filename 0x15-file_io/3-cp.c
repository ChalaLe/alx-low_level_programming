...
/**
 * check1 - checks for the correct number of arguments
...
/**
 * check2 - checks that file_from exists and can be read
...
/**
 * check3 - checks that file_to was created and/or can be written to
 * @check: checks if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
